...
import com.example.oporto_olympics.Controllers.ImportacoesXML.InsercaoXML.InsercaoXMLController;
import com.example.oporto_olympics.Controllers.ImportacoesXML.InsercaoXML.LerXMLController;
...
public class InsercaoXMLModalidadesTest {
    ...
    public void testInsercaoXMLValido() throws ParserConfigurationException, IOException, SAXException, SQLException {
        InsercaoXMLController insercaoxml = new InsercaoXMLController();
        ...
        List<Modalidade> modalidades = lerxml.LerXMLModalidade(xmlValido);
